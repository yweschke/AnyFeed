...
// Using NativeWind's integration, Animated components can accept Tailwind classes.
...
export default function HelloUserLabel({ articles }: HelloUserLabelProps) {
    ...
    // Interpolate header height based on scroll value
    ...
    // Fade out the unread articles text as we scroll down
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            >
                ...
                <AnimatedText className="text-2xl text-white" style={{ opacity: unreadOpacity }}>
                    {t("home.greeting.unreadArticles", { unreadArticles: articleCount })}
                </AnimatedText>
            </AnimatedView>
            <ScrollView style={{ paddingTop: HEADER_MAX_HEIGHT }} // Prevents overlap
                        onScroll={Animated.event(
                            [{ nativeEvent: { contentOffset: { y: scrollY } } }],
                            { useNativeDriver: false }
                        )}>
                <Text className="bg-gray-950 text-white p-4">
